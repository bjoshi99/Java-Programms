...
//      if (!myValueField.getText().equals("")) {
//          newNumber = Integer.parseInt(myValueField.getText());
//          if (newNumber < 0 || newNumber > maxlimit) {
//              myValueField.setText(String.valueOf(myNumber));
//          } else {
//              myNumber = newNumber;
//              myValueField.setText(String.valueOf(newNumber));
//          }
//      } else if (myValueField.getText().equals("")) {
//          myValueField.setText(String.valueOf(myNumber));
//      }
...
//                    myValueSlider.addPropertyChangeListener(new PropertyChanger());
     ...
     * @param theValue current value on text_box.
     * @author Bhavesh Joshi
     * @version Winter 2020.
     */
...
//            if (PROPERTY_BLUE.equals(theEvt.getPropertyName())) {
//                myValueField.setText(theEvt.getNewValue().toString());
//                final int number = (Integer) theEvt.getNewValue();
